...
/*document.addEventListener("DOMContentLoaded", function() {
            ...
            const closeVideoModal = () => {
              // Pause the currently playing video before closing the modal
            ...
            const closePopupButton = document.getElementById(".vid-modal-close-btn");
        ...
        document.addEventListener("DOMContentLoaded", function() {
          let currentlyPlayingVideo; // Variable to hold the currently playing video
          ...
          const videoModal = function(modalClick) {
              video_modalScreens[modalClick].classList.add("active");
              currentlyPlayingVideo = video_modalScreens[modalClick].querySelector("video"); // Get the video inside the modal
          }
